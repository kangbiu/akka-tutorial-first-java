...
public class Pi {
    ...
    public static void main(String[] args) {
        ...
        //10 - 535-554
        //32 - 545-600
        //100 - 605-618 milliseconds
        //1000 - 687-718 milliseconds
        //10000 - 1400milliseconds
        pi.calculate(32, 10000, 10000);
    ...
    static class Work {
        ...
        public String toString() {
            return "Work=" + start + ":" + nrOfElements;
        }
    }
...
//                System.out.println( work + " : " + getContext().self() + " : " + Thread.currentThread().getName());
